        ...
        <div class="container-fluid">
            ...
            <section class="content">
                <div class="row" style="margin-top: 15px;">
                    <div class="col-lg-12">
                        <p>
                            <button type="button" class="btn btn-lg btn-success" id="add_button">添加商品</button>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("#add_button").on("click", function () {
            ...
            $.ajax({
                method: "post",
                url: "{{route('category.add_products')}}",
                data: data,
                beforeSend: function () {
                    // 禁用按钮防止重复提交
                    $("#add_button").html('<i class="fa fa-spin fa-refresh"></i>正在提交...');
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        $(location).prop('href', '/admin/category/chosen_products?category_id='+data.id)
                    } else {
                        $("#add_button").removeAttr("disabled");
                        $("#add_button").html("添加商品");
